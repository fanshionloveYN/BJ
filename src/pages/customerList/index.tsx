...
export default class Index extends Component {
  ...
  getData() {
    get('/admin-api/builder/data/page/reis_customer?customer_name.like='+this.state.searchValue, {
      page:1,
      limit:20,
      ...
      <View className='customerListPage'>
        <View className='searchView'>
          <View className='searchInput'>
            <Input placeholder='请输入客户名称' className='searchInputControl' placeholder-class="place-holder" value={searchValue} onChange={(e) => this.setSearchValue(e)}></Input>
